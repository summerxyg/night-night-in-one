...
public class JAXWSClientTest {
    ...
    public static <INP, OUT> OUT runSOAPMessageTest(String serviceName, INP payload, Class<OUT> expectClazz)
            throws Exception {
        // 1. 创建服务
        ...
        dispatch.getRequestContext()
                .put(com.sun.xml.internal.ws.client.BindingProviderProperties.CONNECT_TIMEOUT, 1000);
        dispatch.getRequestContext()
                .put(com.sun.xml.internal.ws.client.BindingProviderProperties.REQUEST_TIMEOUT, 3000);
